...
test_markdown_list_items ()
{
    ...
    g_assert_true (example233
                   == "<ul>\n<li>\n<p>foo</p>\n<pre><code>bar\n</code></"
                      "pre>\n</li>\n</ul>\n");

    QString example235
        = parse ("    indented code\n\nparagraph\n\n    more code\n");
    g_assert_true (example235
                   == "<pre><code>indented "
                      "code\n</code></pre>\n<p>paragraph</p>\n<pre><code>more "
                      "code\n</code></pre>\n");
...
test_markdown_lists ()
{
    ...
    g_assert_true (example270
                   == "<ul>\n<li>\n<p>foo</p>\n<ul>\n<li>\n<p>bar</"
                      "p>\n<ul>\n<li>\n<p>baz</p>\n<p>bim</p>\n</li>\n</"
                      "ul>\n</li>\n</ul>\n</li>\n</ul>\n");

    QString example273 = parse (
        "- a\n - b\n  - c\n   - d\n    - e\n   - f\n  - g\n - h\n- i\n");
    g_assert_true (
        example273
        == "<ul>\n<li>a</li>\n<li>b</li>\n<li>c</li>\n<li>d</li>\n<li>e</"
    ...
    g_assert_true (example286
                   == "<ul>\n<li>\n<p>foo</p>\n<ul>\n<li>bar</li>\n</"
                      "ul>\n<p>baz</p>\n</li>\n</ul>\n");

    QString example287 = parse ("- a\n  - b\n  - c\n\n- d\n  - e\n  - f\n");
    g_assert_true (example287
                   == "<ul>\n<li>\n<p>a</p>\n<ul>\n<li>b</li>\n<li>c</li>\n</"
                      "ul>\n</li>\n<li>\n<p>d</p>\n<ul>\n<li>e</li>\n<li>f</"
                      "li>\n</ul>\n</li>\n</ul>\n");
}
...
test_markdown_emphasis ()
{
    ...
    g_assert_true (example390
                   == "<p><em>foo <strong>bar</strong> baz</em></p>\n");

    QString example391 = parse ("*foo**bar**baz*\n");
    g_assert_true (example391
                   == "<p><em>foo<strong>bar</strong>baz</em></p>\n");
    ...
    g_assert_true (example405
                   == "<p><strong>foo <em>bar</em> baz</strong></p>\n");

    QString example406 = parse ("**foo*bar*baz**\n");
    g_assert_true (example406
                   == "<p><strong>foo<em>bar</em>baz</strong></p>\n");
    ...
    g_assert_true (example441
                   == "<p><strong><strong>foo</strong></strong></p>\n");

    QString example442 = parse ("____foo____\n");
    g_assert_true (example442
                   == "<p><strong><strong>foo</strong></strong></p>\n");

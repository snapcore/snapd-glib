 ...
 *
 * Version of markdown to parse. Picking a version will ensure only nodes of
 * the expected type are decoded.
 *
 * Since: 1.48
 */
typedef enum
...
G_DECLARE_FINAL_TYPE (SnapdMarkdownParser,
                      snapd_markdown_parser,
                      SNAPD,
                      MARKDOWN_PARSER,
                      GObject)
...
void
snapd_markdown_parser_set_preserve_whitespace (SnapdMarkdownParser *parser,

 ...
 * confinement.
 * @SNAPD_INSTALL_FLAGS_DANGEROUS: Install the given snap file even if there
 * are no pre-acknowledged signatures for it, meaning it was not verified and
 ...
 * @SNAPD_GET_INTERFACES_FLAGS_ONLY_CONNECTED: Only return connected
 * interfaces.
 *
 ...
 * Since: 1.0
 */
typedef void (*SnapdProgressCallback) (SnapdClient *client,
                                       SnapdChange *change,
                                       gpointer deprecated,
                                       gpointer user_data);
 ...
 * Since: 1.64
 */
typedef void (*SnapdLogCallback) (SnapdClient *client,
                                  SnapdLog *log,
                                  gpointer user_data);
...
gboolean snapd_client_get_connections_sync (SnapdClient *client,
                                            ...
                                            GCancellable *cancellable,
                                            GError **error)
    G_DEPRECATED_FOR (snapd_client_get_connections2_sync);
...
GPtrArray *snapd_client_find_section_sync (SnapdClient *client,
                                           ...
                                           GCancellable *cancellable,
                                           GError **error)
    G_DEPRECATED_FOR (snapd_client_find_category_sync);
...
gboolean snapd_client_run_snapctl_sync (SnapdClient *client,
                                        ...
                                        GCancellable *cancellable,
                                        GError **error)
    G_DEPRECATED_FOR (snapd_client_run_snapctl2_sync);
...
gboolean
snapd_client_install_themes_sync (SnapdClient *client,
                                  GStrv gtk_theme_names,
                                  GStrv icon_theme_names,
                                  GStrv sound_theme_names,
                                  SnapdProgressCallback progress_callback,
                                  ...
                                  GError **error);
void
snapd_client_install_themes_async (SnapdClient *client,
                                   GStrv gtk_theme_names,
                                   GStrv icon_theme_names,
                                   GStrv sound_theme_names,
                                   SnapdProgressCallback progress_callback,
...
GPtrArray *
snapd_client_get_notices_with_filters_sync (SnapdClient *client,
                                            gchar *user_id,
                                            gchar *users,
                                            gchar *types,
                                            gchar *keys,

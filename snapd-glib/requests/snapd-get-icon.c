...
SnapdGetIcon *
_snapd_get_icon_new (const gchar *name,
                     GCancellable *cancellable,
                     GAsyncReadyCallback callback,
                     gpointer user_data)
{
    SnapdGetIcon *self = SNAPD_GET_ICON (g_object_new (
        snapd_get_icon_get_type (), "cancellable", cancellable,
                         ...
                         GError **error)
{
    ...
    g_autoptr (SnapdIcon) icon = g_object_new (
        SNAPD_TYPE_ICON, "mime-type", content_type, "data", body, NULL);

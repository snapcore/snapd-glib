...
G_DEFINE_TYPE (SnapdGetInterfacesLegacy,
...
_snapd_get_interfaces_legacy_new (GCancellable *cancellable,
                                  ...
                                  gpointer user_data)
{
    return SNAPD_GET_INTERFACES_LEGACY (g_object_new (
        snapd_get_interfaces_legacy_get_type (), "cancellable", cancellable,
...
static gboolean
parse_get_interfaces_legacy_response (SnapdRequest *request,
                                      guint status_code,
...
snapd_get_interfaces_legacy_finalize (GObject *object)
{
    ...
    G_OBJECT_CLASS (snapd_get_interfaces_legacy_parent_class)
        ->finalize (object);
}

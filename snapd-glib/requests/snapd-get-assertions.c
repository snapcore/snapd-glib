...
G_DEFINE_TYPE (SnapdGetAssertions,
               snapd_get_assertions,
               snapd_request_get_type ())

SnapdGetAssertions *
_snapd_get_assertions_new (const gchar *type,
                               ...
                               GError **error)
{
    ...
    while (offset < data_length) {
        ...
        /* Skip over body */
        gsize body_length = body_length_header != NULL
                                ? strtoul (body_length_header, NULL, 10)
                                : 0;
        if (body_length > 0)
        ...
        g_ptr_array_add (assertions,
                         g_strndup (data + assertion_start,

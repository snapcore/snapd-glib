...
SnapdGetLogs *
_snapd_get_logs_new (gchar **names,
                     size_t n,
                     gboolean follow,
                     SnapdGetLogsLogCallback log_callback,
                     gpointer log_callback_data,
                     ...
                     gpointer user_data)
{
    SnapdGetLogs *self = SNAPD_GET_LOGS (g_object_new (
        snapd_get_logs_get_type (), "cancellable", cancellable,
...
static gboolean
parse_get_logs_response (SnapdRequest *request,
                         guint status_code,
...
parse_get_logs_json_seq (SnapdRequest *request, JsonNode *seq, GError **error)
{
    ...
    log = g_object_new (snapd_log_get_type (), "timestamp", timestamp,
                        "message", message, "sid", sid, "pid", pid, NULL);

                               ...
                               GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_get_changes_async (self, filter, snap_name, cancellable,
                                    sync_cb, &data);
    end_sync (&data);
                                          ...
                                          GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_get_system_information_async (self, cancellable, sync_cb,
                                               &data);
    end_sync (&data);

    return snapd_client_get_system_information_finish (self, data.result,
                                                       error);
}
                                 ...
                                 GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_set_snap_conf_async (self, name, key_values, cancellable,
                                      sync_cb, &data);
    end_sync (&data);
                             ...
                             GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_get_apps2_async (self, flags, snaps, cancellable, sync_cb,
                                  &data);
    end_sync (&data);
                             ...
                             GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_get_snaps_async (self, flags, names, cancellable, sync_cb,
                                  &data);
    end_sync (&data);
                                  ...
                                  GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_get_assertions_async (self, type, cancellable, sync_cb,
                                       &data);
    end_sync (&data);
                                   ...
                                   GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_get_interfaces2_async (self, flags, names, cancellable,
                                        sync_cb, &data);
    end_sync (&data);
                                   ...
                                   GError **error)
{
    ...
    end_sync (&data);
    G_GNUC_BEGIN_IGNORE_DEPRECATIONS
    return snapd_client_get_connections_finish (
        self, data.result, established, undesired, plugs, slots, error);
    G_GNUC_END_IGNORE_DEPRECATIONS
}
                                    ...
                                    GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_get_connections2_async (self, flags, snap, interface,
                                ...
                                GError **error)
{
    ...
    end_sync (&data);
    G_GNUC_BEGIN_IGNORE_DEPRECATIONS
    return snapd_client_find_section_finish (self, data.result,
                                 ...
                                 GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_find_category_async (self, flags, category, query,
                                      cancellable, sync_cb, &data);
    end_sync (&data);
 ...
 * %NULL to ignore.
 *
 * Find snaps in store that are newer revisions than locally installed
 * versions.
 *
 * Returns: (transfer container) (element-type SnapdSnap): an array of
 * #SnapdSnap or %NULL on error.
...
snapd_client_install_sync (SnapdClient *self,
                           ...
                           GError **error)
{
    return snapd_client_install2_sync (
                       ...
                       GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_try_async (self, path, progress_callback,
...
snapd_client_remove_sync (SnapdClient *self,
                          ...
                          GError **error)
{
    return snapd_client_remove2_sync (
        self, SNAPD_REMOVE_FLAGS_NONE, name, progress_callback,
        progress_callback_data, cancellable, error);
}
                               ...
                               GError **error)
{
    ...
    start_sync (&data);
    G_GNUC_BEGIN_IGNORE_DEPRECATIONS
    snapd_client_run_snapctl_async (self, context_id, args, cancellable,
                                    sync_cb, &data);
    end_sync (&data);
                                ...
                                GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_run_snapctl2_async (self, context_id, args, cancellable,
                                     sync_cb, &data);
    end_sync (&data);
 ...
 */
gboolean
snapd_client_check_themes_sync (SnapdClient *self,
                                ...
                                GError **error)
{
    ...
    snapd_client_check_themes_async (self, gtk_theme_names, icon_theme_names,
                                     ...
                                     &data);
    end_sync (&data);
    return snapd_client_check_themes_finish (
        self, data.result, gtk_theme_status, icon_theme_status,
 ...
 */
gboolean
snapd_client_install_themes_sync (SnapdClient *self,
                                  GStrv gtk_theme_names,
                                  GStrv icon_theme_names,
                                  GStrv sound_theme_names,
                                  SnapdProgressCallback progress_callback,
                                  ...
                                  GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_install_themes_async (self, gtk_theme_names, icon_theme_names,
                                       sound_theme_names, progress_callback,
                                       progress_callback_data, cancellable,
                                       sync_cb, &data);
    end_sync (&data);
                               ...
                               GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_follow_logs_async (self, names, log_callback,
                                    log_callback_data, cancellable, sync_cb,
                                    &data);
    end_sync (&data);
                               ...
                               GError **error)
{
    ...
    g_auto (SyncData) data = { 0 };
    start_sync (&data);
    snapd_client_get_notices_async (self, since_date_time, timeout,
                                    cancellable, sync_cb, &data);
    end_sync (&data);
                                            ...
                                            GError **error)
{
    ...
    snapd_client_get_notices_with_filters_async (
        self, user_id, users, types, keys, since_date_time, timeout,
        cancellable, sync_cb, &data);
    end_sync (&data);
    return snapd_client_get_notices_with_filters_finish (self, data.result,
                                                         error);
}

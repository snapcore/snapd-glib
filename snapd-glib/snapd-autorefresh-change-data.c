...
G_DEFINE_TYPE (SnapdAutorefreshChangeData,
 ...
 *
 * return: (transfer none): a GStrv with the snap names, or NULL if the
...
static void
snapd_autorefresh_change_data_set_property (GObject *object,
                                            guint prop_id,
                                            const GValue *value,
                                            GParamSpec *pspec)
{
...
static void
snapd_autorefresh_change_data_get_property (GObject *object,
                                            guint prop_id,
                                            GValue *value,
                                            GParamSpec *pspec)
{
...
snapd_autorefresh_change_data_finalize (GObject *object)
{
    ...
    G_OBJECT_CLASS (snapd_autorefresh_change_data_parent_class)
        ->finalize (object);
}

static void
snapd_autorefresh_change_data_class_init (

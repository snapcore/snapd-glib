...
class Q_DECL_EXPORT QSnapdLoginRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdLoginRequest (void *snapd_client,
                                 const QString &email,
...
class Q_DECL_EXPORT QSnapdLogoutRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdLogoutRequest (void *snapd_client,
                                  qint64 id,
                                  QObject *parent = 0);
    ~QSnapdLogoutRequest ();
    virtual void runSync ();
...
class Q_DECL_EXPORT QSnapdGetChangesRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdGetChangesRequest (int filter,
...
class Q_DECL_EXPORT QSnapdGetChangeRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdGetChangeRequest (const QString &id,
                                     void *snapd_client,
                                     QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdAbortChangeRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdAbortChangeRequest (const QString &id,
                                       void *snapd_client,
                                       QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdGetSystemInformationRequest : public QSnapdRequest {
    Q_OBJECT
    Q_PROPERTY (
        QSnapdSystemInformation *systemInformation READ systemInformation)
...
class Q_DECL_EXPORT QSnapdGetSnapsRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdGetSnapsRequest (int flags,
...
class Q_DECL_EXPORT QSnapdListOneRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdListOneRequest (const QString &name,
                                   void *snapd_client,
                                   QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdGetSnapRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdGetSnapRequest (const QString &name,
                                   void *snapd_client,
                                   QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdGetAppsRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdGetAppsRequest (int flags,
                                   void *snapd_client,
                                   QObject *parent = 0);
    explicit QSnapdGetAppsRequest (int flags,
                                   const QStringList &snaps,
...
class Q_DECL_EXPORT QSnapdGetIconRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdGetIconRequest (const QString &name,
                                   void *snapd_client,
                                   QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdGetAssertionsRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdGetAssertionsRequest (const QString &type,
                                         void *snapd_client,
                                         QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdGetConnectionsRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdGetConnectionsRequest (int flags,
                                          const QString &snap,
...
class Q_DECL_EXPORT QSnapdGetInterfacesRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdGetInterfacesRequest (void *snapd_client,
                                         QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdGetInterfaces2Request : public QSnapdRequest {
  ...
  public:
    explicit QSnapdGetInterfaces2Request (int flags,
...
class Q_DECL_EXPORT QSnapdFindRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdFindRequest (int flags,
...
class Q_DECL_EXPORT QSnapdInstallRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdInstallRequest (int flags,
                                   const QString &name,
...
class Q_DECL_EXPORT QSnapdTryRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdTryRequest (const QString &path,
                               void *snapd_client,
                               QObject *parent = 0);
    ~QSnapdTryRequest ();
    virtual void runSync ();
...
class Q_DECL_EXPORT QSnapdRefreshRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdRefreshRequest (const QString &name,
                                   const QString &channel,
                                   void *snapd_client,
                                   QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdRemoveRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdRemoveRequest (int flags,
                                  const QString &name,
                                  void *snapd_client,
                                  QObject *parent = 0);
    ~QSnapdRemoveRequest ();
...
class Q_DECL_EXPORT QSnapdEnableRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdEnableRequest (const QString &name,
                                  void *snapd_client,
                                  QObject *parent = 0);
    ~QSnapdEnableRequest ();
    virtual void runSync ();
...
class Q_DECL_EXPORT QSnapdDisableRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdDisableRequest (const QString &name,
                                   void *snapd_client,
                                   QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdBuyRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdBuyRequest (const QString &id,
                               double amount,
...
class Q_DECL_EXPORT QSnapdCreateUserRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdCreateUserRequest (const QString &email,
                                      int flags,
                                      void *snapd_client,
                                      QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdCreateUsersRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdCreateUsersRequest (void *snapd_client,
                                       QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdGetSectionsRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdGetSectionsRequest (void *snapd_client,
                                       QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdGetCategoriesRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdGetCategoriesRequest (void *snapd_client,
                                         QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdAliasRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdAliasRequest (const QString &snap,
                                 const QString &app,
                                 const QString &alias,
                                 void *snapd_client,
                                 QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdUnaliasRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdUnaliasRequest (const QString &snap,
                                   const QString &alias,
                                   void *snapd_client,
                                   QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdPreferRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdPreferRequest (const QString &snap,
                                  void *snapd_client,
                                  QObject *parent = 0);
    ~QSnapdPreferRequest ();
    virtual void runSync ();
...
class Q_DECL_EXPORT QSnapdDownloadRequest : public QSnapdRequest {
  ...
  public:
    explicit QSnapdDownloadRequest (const QString &name,
                                    const QString &channel,
                                    const QString &revision,
                                    void *snapd_client,
                                    QObject *parent = 0);
...
class Q_DECL_EXPORT QSnapdClient : public QObject {
  ...
  public:
    ...
    Q_INVOKABLE QSnapdGetSnapConfRequest *
    getSnapConf (const QString &name, const QStringList &keys);
    ...
    Q_INVOKABLE QSnapdGetAssertionsRequest *
    getAssertions (const QString &type);
    ...
    getInterfaces2 (InterfaceFlags flags);
    Q_INVOKABLE QSnapdGetInterfaces2Request *
    ...
    connectInterface (const QString &plug_snap,
                      const QString &plug_name,
                      const QString &slot_snap,
                      const QString &slot_name);
    Q_INVOKABLE QSnapdDisconnectInterfaceRequest *
    disconnectInterface (const QString &plug_snap,
                         const QString &plug_name,
                         const QString &slot_snap,
                         const QString &slot_name);
    ...
    Q_INVOKABLE Q_DECL_DEPRECATED_X ("Use findCategory()")
        QSnapdFindRequest *findSection (const QString &section,
                                        const QString &query);
    Q_INVOKABLE Q_DECL_DEPRECATED_X ("Use findCategory()")
        QSnapdFindRequest *findSection (FindFlags flags,
                                        const QString &section,
                                        const QString &query);
    Q_INVOKABLE QSnapdFindRequest *findCategory (const QString &category,
                                                 const QString &query);
    Q_INVOKABLE QSnapdFindRequest *findCategory (FindFlags flags,
                                                 const QString &category,
                                                 const QString &query);
    ...
    Q_INVOKABLE QSnapdSwitchChannelRequest *
    switchChannel (const QString &name, const QString &channel);
    Q_INVOKABLE QSnapdCheckBuyRequest *checkBuy ();
    Q_INVOKABLE QSnapdBuyRequest *
    buy (const QString &id, double amount, const QString &currency);
    ...
    Q_INVOKABLE QSnapdAliasRequest *
    alias (const QString &snap, const QString &app, const QString &alias);

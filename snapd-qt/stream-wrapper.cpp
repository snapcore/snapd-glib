...
static gssize
stream_wrapper_read_fn (GInputStream *stream,
                        void *buffer,
                        gsize count,
...
static gboolean
stream_wrapper_close_fn (GInputStream *stream,
                         GCancellable *cancellable,
                         GError **error)
{
    StreamWrapper *wrapper = SNAPD_STREAM_WRAPPER (stream);
...
static void
stream_wrapper_init (StreamWrapper *wrapper)
{
}

static void
stream_wrapper_class_init (StreamWrapperClass *klass)
{

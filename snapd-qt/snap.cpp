...
QSnapdCategory *
QSnapdSnap::category (int n) const
{
    GPtrArray *categories;
...
QSnapdChannel *
QSnapdSnap::channel (int n) const
{
    GPtrArray *channels;
...
QSnapdChannel *
QSnapdSnap::matchChannel (const QString &name) const
{
    SnapdChannel *channel = snapd_snap_match_channel (
        SNAPD_SNAP (wrapped_object), name.toStdString ().c_str ());
    if (channel == NULL)
        return NULL;
...
QSnapdEnums::SnapConfinement
QSnapdSnap::confinement () const
{
...
QString
QSnapdSnap::revision () const
{
    return snapd_snap_get_revision (SNAPD_SNAP (wrapped_object));
}

int
QSnapdSnap::screenshotCount () const
{
...
QSnapdScreenshot *
QSnapdSnap::screenshot (int n) const
{
    GPtrArray *screenshots;
...
QSnapdEnums::SnapType
QSnapdSnap::snapType () const
{
...
QSnapdEnums::SnapStatus
QSnapdSnap::status () const
{

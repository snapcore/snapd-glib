...
QDateTime
QSnapdTask::spawnTime () const
{
    return convertDateTime (
        snapd_task_get_spawn_time (SNAPD_TASK (wrapped_object)));
}

QDateTime
QSnapdTask::readyTime () const
{
    return convertDateTime (
        snapd_task_get_ready_time (SNAPD_TASK (wrapped_object)));
}

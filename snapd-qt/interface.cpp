...
QSnapdSlot *
QSnapdInterface::slot (int n) const
{
    GPtrArray *slots;
...
int
QSnapdInterface::plugCount () const
{
    GPtrArray *plugs;
...
QSnapdPlug *
QSnapdInterface::plug (int n) const
{
    GPtrArray *plugs;
...
QString
QSnapdInterface::makeLabel () const
{

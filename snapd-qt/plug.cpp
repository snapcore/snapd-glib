...
bool
QSnapdPlug::hasAttribute (const QString &name) const
{
...
QVariant
QSnapdPlug::attribute (const QString &name) const
{
...
QString
QSnapdPlug::label () const
{
    return snapd_plug_get_label (SNAPD_PLUG (wrapped_object));
}

int
QSnapdPlug::connectionCount () const
{
...
QSnapdConnection *
QSnapdPlug::connection (int n) const
{
    GPtrArray *connections;
...
int
QSnapdPlug::connectedSlotCount () const
{
    GPtrArray *connections;
...
QSnapdSlotRef *
QSnapdPlug::connectedSlot (int n) const
{
    GPtrArray *connections;
